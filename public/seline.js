(() => {
  function O(r) {
    let c = "seline_vid",
      ...
      o = {},
      S = null,
      l = sessionStorage.getItem("seline:referrer") ? "" : document.referrer;
    function b(t) {
    ...
    function E(t, e, i = 365) {
      ...
      let a = location.hostname.split(".").slice(-2).join(".");
    ...
    function w(t) {
      let e = k.map((n) => new RegExp(`^${n.replace(/\*/g, "[^/]+")}$`)),
    ...
    function h(t, e, i = !0) {
      ...
      return (
        ...
        i && navigator?.sendBeacon
          ? (navigator.sendBeacon(t, JSON.stringify(n)), Promise.resolve())
          : fetch(t, {
              method: "POST",
    ...
    function y(t, e) {
      let i = w(window.location.pathname);
    ...
    function g(t) {
      ...
      i &&
        ...
        l && ((l = null), sessionStorage.setItem("seline:referrer", "set")));
    }
    function $(t) {
      (o = { ...o, ...t }),
    ...
    function C() {
      document.addEventListener("click", (t) => {
        ...
        if (
          ...
          return;
        for (; e && !e?.hasAttribute("data-sln-event"); ) e = e.parentElement;
        if (!e) return;
        let i = e.getAttribute("data-sln-event");
        if (!i) return;
        let n = {};
        ...
        if (e.tagName === "FORM") {
          ...
          for (let m of N)
            m.type !== "password" && m.name && m.value && (n[m.name] = m.value);
        }
        y(i, n);
      });
    }
  ...
  if (!window.seline) {
    let c = function (s) {
      ...
      k =
        document.currentScript?.getAttribute("data-cookie-on-identify") ===
        "true",
      v = O({
        token: r,
        skipPatterns: f,
